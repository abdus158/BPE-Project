...
public class Provide_A_ServicesProxy implements main_pkg.Provide_A_Services {
  private String _endpoint = null;
  private main_pkg.Provide_A_Services provide_A_Services = null;
  ...
  private void _initProvide_A_ServicesProxy() {
    try {
      provide_A_Services = (new main_pkg.Provide_A_ServicesServiceLocator()).getProvide_A_Services();
  ...
  public main_pkg.Provide_A_Services getProvide_A_Services() {
    if (provide_A_Services == null)
      _initProvide_A_ServicesProxy();
