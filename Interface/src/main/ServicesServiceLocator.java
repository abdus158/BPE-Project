...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements main.ServicesService {
    ...
    public main.Services getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.ServicesSoapBindingStub _stub = new main.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                main.ServicesSoapBindingStub _stub = new main.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
