...
public class Provide_A_ServicesServiceLocator extends org.apache.axis.client.Service implements main.Provide_A_ServicesService {
    ...
    public main.Provide_A_Services getProvide_A_Services() throws javax.xml.rpc.ServiceException {
    ...
    public main.Provide_A_Services getProvide_A_Services(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.Provide_A_ServicesSoapBindingStub _stub = new main.Provide_A_ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Provide_A_Services.class.isAssignableFrom(serviceEndpointInterface)) {
                main.Provide_A_ServicesSoapBindingStub _stub = new main.Provide_A_ServicesSoapBindingStub(new java.net.URL(Provide_A_Services_address), this);
                _stub.setPortName(getProvide_A_ServicesWSDDServiceName());
                return _stub;
            }
        }
